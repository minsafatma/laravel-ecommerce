...
@section('admin_content')
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">MANUFACTURE</h2>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form   action="{{ url('/save-manufacture') }}" method="post">
							 ...
							 <input type="text" class="form-control" id="exampleInput1" name="manufac_name"> </div> <div class="form-group"> <label for="exampleInput">Manufacture Description</label>
							  <textarea class="form-control" name="manufac_des"rows="9"></textarea> </div>
