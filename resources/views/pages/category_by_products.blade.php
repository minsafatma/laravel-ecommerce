                ...
                <?php
				 ...
				 <a href="single.html"><div class="product-grid">					  
						...
						<div class="product-img b-link-stripe b-animate-go  thickbox">						   
							<img src='{{asset($v_category_by_product->pro_img)}}' class="img-responsive" alt=""/>
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>{{$v_category_by_product->pro_name}}</h4>
								<span class="item_price">{{$v_category_by_product->pro_price}}TK</span>
