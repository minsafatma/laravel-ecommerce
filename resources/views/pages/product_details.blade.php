			 ...
			 <div class="content-bar">
				 <div class="single-page">					 
					 <!--Include the Etalage files-->
						<link rel="stylesheet" href="{{asset('frontendd/css/etalage.css')}}">
						<script src="{{asset('frontendd/js/jquery.etalage.min.js')}}"></script>
					 <!-- Include the Etalage files -->
					 <script>
					 ...
					 <div class="details-left-slider">
						  <ul id="etalage">
							 <li>
								...
								<img class="etalage_thumb_image" src="{{url::to('frontend/images/s1.jpg')}}" />
								<img class="etalage_source_image" src="{{url::to('frontend/images/s1.jpgg')}}" />
								</a>
							 </li>
							 <li>
								<img class="etalage_thumb_image" src="{{url::to('$product_by_details->pro_img')}}"/>
								<img class="etalage_source_image" src="{{url::to('$product_by_details->pro_img')}}"/>
							 </li>
							 <li>
								<img class="etalage_thumb_image" src="{{url::to('$product_by_details->pro_img')}}" />
								<img class="etalage_source_image" src="{{url::to('$product_by_details->pro_img')}}" />
					 ...
					 <div class="details-left-info">
							<h3>{{$product_by_details->pro_name}}</h3>
								<h4>{{$product_by_details->pro_color}} </h4>
								<img class="etalage_source_image" src="{{url::to('$product_by_details->pro_img')}}" />							
							<p>{{$product_by_details->pro_price}} TK<a href="#">Click for offer</a></p>
							...
							<p>Brand  ::<a href="#">{{$product_by_details->manufac_name}}</a></p>
							<p>category  ::<a href="#">{{$product_by_details->category_name}}</a></p>
							<p>Size  ::<a href="#">{{$product_by_details->pro_size}}</a></p>
							</div>
							<h5>Description  ::{{$product_by_details->pro_i_des}}</h5>
...
<div class="fotter-logo">
	 ...
	 <div class="ftr-info">
	 <p>&copy; 2015 All Rights Reseverd Design by minsa </p>
	</div>
	 <div class="clearfix"></div>
	 </div>
</div>
